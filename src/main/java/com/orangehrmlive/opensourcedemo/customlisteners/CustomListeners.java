package com.orangehrmlive.opensourcedemo.customlisteners;
...
import static com.orangehrmlive.opensourcedemo.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("orangehrmlive");
